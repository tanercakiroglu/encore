...
public class FileController implements IFileController {
    ...
    public Object getFile(@RequestParam("id") String id, HttpServletRequest request, HttpServletResponse response) throws BusinessException {
        ...
        String encodedString = Base64.encodeBase64String(file.getFileData());
        GetFileResponse res = new GetFileResponse(file.getId(), file.getFileName(),encodedString, file.getFileType());
